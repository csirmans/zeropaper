...
> **Status:** Historical implementation plan. Corbis MCP plumbing and later Phase 2 agent updates have landed; use `setup.sh`, `templates/docs/CORBIS_MCP_GUIDE.md`, `templates/utils/corbis/preflight.py`, `templates/skill_bodies/corbis/corbis.md`, and the current agent bodies as the operational source of truth.
